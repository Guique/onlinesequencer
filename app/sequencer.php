...
<div id="toolbar_element">
    ...
    <div id="share" style="display: none"><div class="btn" id="btn_close" onclick="$('#share').remove();"> </div>Link to this sequence: <span id="sharelink"><?php if($id) echo $id; ?></span></div>
